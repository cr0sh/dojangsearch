...
function formatDate(date) {
	...
	<div id="result">
		...
		알림: 최근 랭킹의 달성 날짜가 적절하지 않은 오류가 발견되어 수정되었습니다. 그러나 이미 수집된 랭킹 DB를 수정할 수는 없으므로 2018-02-24 이전의 '최근 랭킹' 달성 날짜는 주 단위로만 정확함을 인지해 주시기 바랍니다. 2018년 3월 중에 2018-02-24부터 다시 수집한 DB로 교체할 예정입니다. (기존 DB도 교체 전까지 계속 업데이트됩니다)
	</div>
</body>
</html>
`
